...
style_duo_accent(
  ...
  title_slide_background_image = "illustrations/robots-cover.jpeg",
...
knitr::include_graphics("illustrations/robots-background.png")
```

---

background-image: url(illustrations/robots-what-why.jpeg)
...
background-image: url(illustrations/robots-options.jpeg)
background-position: center
background-repeat: no-repeat
background-size: contain
class: middle, inverse
...
background-image: url(illustrations/robot-r.jpeg)
background-position: center
background-repeat: no-repeat
background-size: contain
class: middle
...
background-image: url(illustrations/robot-r-python.jpeg)
background-position: center
background-repeat: no-repeat
background-size: contain
class: middle
...
knitr::include_graphics("illustrations/jupyter-r.png")
```
]
--
.pull-right[
```{r echo=FALSE, fig.align="center", out.width="100%"}
knitr::include_graphics("illustrations/r-python.png")
```
]
...
knitr::include_graphics("illustrations/tests-as-feeback.png")
```
...
```{r echo=FALSE, fig.align="center", out.width="75%"}
knitr::include_graphics("illustrations/grading.png")
```
...
knitr::include_graphics("illustrations/feedback-forms.png")
```
]
--
.pull-right[
```{r echo=FALSE, fig.align="center", out.width="130%"}
knitr::include_graphics("illustrations/feedback-forms2.png")
```
]

---

background-image: url(illustrations/robots-demo.jpeg)
background-position: center
background-repeat: no-repeat
background-size: contain
class: middle
...
- [examples of Python Jupyter notebooks with automated feedback from Berkley's data8 course](https://github.com/UBC-DSCI/dsci-100-assets/tree/master/2019-spring/materials)

---

background-image: url(illustrations/robots-last.jpeg)
background-position: center
background-repeat: no-repeat
background-size: contain
class: middle, inverse
